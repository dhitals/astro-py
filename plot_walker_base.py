...
""" Visualization code written to create diagnostic plots of MCMC walkers.
    Takes the columns of the output file and plots it asa function of N_iterations
        as well as an histogram.
